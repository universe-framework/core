 ...
 */
@Path("people")
public class PersonService extends AbstractCRUDService<eu.lpinto.universe.persistence.entities.Person, Person, eu.lpinto.universe.controllers.PersonController, PersonDTS> {
